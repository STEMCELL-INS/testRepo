...
std::string dir = "C:\\projects\\EasyPickFL_ImgProcessing\\trouble images";
...
int main(int, char** argv)
{
	...
	for(int i=0; i< imgFiles.size(); ++i) {
		...
		Circle well_circle;
		well_circle = EasyPickLibrary::imgProcFunctions::well_boundary_detection(src, 35, 13, 3);
		...
		std::vector<std::vector<int>> links = imgProcFunctions::link_halo_spot(spots, halos, 20);
		// spots
